...
var $author$project$Main$Model = F4(
	function (route, questions, uid, language) {
		return {language: language, questions: questions, route: route, uid: uid};
	});
...
var $author$project$Main$Summary = {$: 'Summary'};
...
var $author$project$Main$questionViewElement = F2(
	function (answers, questionText) {
		return A2(
...
var $author$project$Main$QuestionView = function (a) {
	return {$: 'QuestionView', a: a};
};
...
var $author$project$Main$wrapQuestionViewIntoButton = F2(
	function (questionType, questionElement) {
		return A2(
				...
				]),
			{
				...
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$ChangeView(
						$author$project$Main$QuestionView(questionType)))
			});
	});
var $author$project$Main$getSquare = F2(
	function (language, quesiton) {
		if (quesiton.$ === 'Just') {
			...
			var linkElement = A2(
				$author$project$Main$wrapQuestionViewIntoButton,
				questionType,
				A2(
					$author$project$Main$questionViewElement,
					answers,
					A2($author$project$Main$getTranslatedText, language, questionType)));
			switch (questionType.$) {
				case 'YesYes':
					return A2(
						$mdgriffith$elm_ui$Element$el,
...
var $author$project$Main$languageChange = A2(
...
var $author$project$Main$backLink = A2(
		...
		]),
	{
		label: A2(
			...
			$mdgriffith$elm_ui$Element$text('🔙')),
		onPress: $elm$core$Maybe$Just(
			$author$project$Main$ChangeView($author$project$Main$Summary))
	});
...
var $author$project$Main$mainElement = function (model) {
	var summaryView = A2(
		...
		A2(
			$elm$core$List$cons,
			$mdgriffith$elm_ui$Element$inFront($author$project$Main$languageChange),
			$author$project$Main$fillStyle),
		_List_fromArray(
			[
				A2(
	...
	var _v0 = model.route;
	if (_v0.$ === 'QuestionView') {
		var questionType = _v0.a;
		var _v1 = A2($author$project$Main$getQuestionByType, questionType, model.questions);
		if (_v1.$ === 'Just') {
			var selectedQuestion = _v1.a;
			return A2($author$project$Main$questionView, model.language, selectedQuestion);
		} else {
			return summaryView;
		}
	} else {
