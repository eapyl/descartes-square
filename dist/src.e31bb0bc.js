...
var $author$project$Main$Question = F3(
	function (questionType, field, answers) {
		return {answers: answers, field: field, questionType: questionType};
	});
var $author$project$Main$YesNo = {$: 'YesNo'};
var $author$project$Main$YesYes = {$: 'YesYes'};
	...
	function (_v0, url, key) {
		return _Utils_Tuple2(
			A6(
				...
				_List_fromArray(
					[
						A3($author$project$Main$Question, $author$project$Main$YesYes, '', _List_Nil),
						A3($author$project$Main$Question, $author$project$Main$YesNo, '', _List_Nil),
						A3($author$project$Main$Question, $author$project$Main$NoYes, '', _List_Nil),
						A3($author$project$Main$Question, $author$project$Main$NoNo, '', _List_Nil)
					]),
				0,
				$author$project$Main$En),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$newAnswerIdValue = 'new-answer';
var $author$project$Main$changeFocusToNewAnswer = A2(
...
var $author$project$Main$newAnswerForQuestion = F2(
		...
		return _Utils_update(
			question,
			{
				answers: _Utils_ap(
					...
					_List_fromArray(
						[
							A2($author$project$Main$Answer, id, question.field)
						])),
				field: ''
			});
	});
...
var $author$project$Main$updateQuestionAnswer = F3(
	function (id, newText, question) {
		return _Utils_update(
			question,
			{
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							questions: A2(
								$elm$core$List$map,
								A2($author$project$Main$updateQuestionAnswer, id, newText),
								model.questions)
						}),
					...
					_Utils_update(
						model,
						{
							questions: A2(
								$elm$core$List$map,
								function (q) {
									return _Utils_eq(q.questionType, question.questionType) ? A2($author$project$Main$newAnswerForQuestion, model.uid, q) : q;
								},
								model.questions),
							uid: model.uid + 1
						}),
					...
					_Utils_update(
						model,
						{
							questions: A2(
								$elm$core$List$map,
								function (q) {
									return _Utils_eq(q.questionType, questionType) ? A2($author$project$Main$updateField, newText, q) : q;
								},
								model.questions)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeLanguage':
				var translation = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$blue = A3($mdgriffith$elm_ui$Element$rgb255, 59, 130, 246);
...
var $author$project$Main$info = A2(
...
var $author$project$Main$languageChange = function (color) {
	return A2(
		...
		_List_fromArray(
			[
					...
					]),
				{
					label: $mdgriffith$elm_ui$Element$text('🇷🇺'),
					onPress: $elm$core$Maybe$Just(
						$author$project$Main$ChangeLanguage($author$project$Main$Ru))
				})
			]));
};
...
var $author$project$Main$fillStyle = _List_fromArray(
	[
...
var $author$project$Main$routeToQuestionType = function (route) {
	return A2($elm$core$String$endsWith, 'yes-yes', route) ? $elm$core$Maybe$Just($author$project$Main$YesYes) : (A2($elm$core$String$endsWith, 'yes-no', route) ? $elm$core$Maybe$Just($author$project$Main$YesNo) : (A2($elm$core$String$endsWith, 'no-yes', route) ? $elm$core$Maybe$Just($author$project$Main$NoYes) : (A2($elm$core$String$endsWith, 'no-no', route) ? $elm$core$Maybe$Just($author$project$Main$NoNo) : $elm$core$Maybe$Nothing)));
};
var $author$project$Main$getQuestion = function (model) {
	return A2(
		...
		function (selectedQuestionType) {
			return $elm$core$List$head(
				A2(
					$elm$core$List$filter,
					function (q) {
						return _Utils_eq(q.questionType, selectedQuestionType);
					},
					model.questions));
		},
		$author$project$Main$routeToQuestionType(
			A2($elm$core$String$dropLeft, 1, model.url.path)));
};
var $author$project$Main$getQuestionByType = F2(
	function (questionType, questions) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (q) {
					return _Utils_eq(q.questionType, questionType);
				},
				questions));
	});
...
var $author$project$Main$fontSizeQuestionText = 24;
...
var $author$project$Main$getTranslatedText = F2(
	function (translation, questionType) {
		var _v0 = _Utils_Tuple2(translation, questionType);
		if (_v0.a.$ === 'En') {
			switch (_v0.b.$) {
				case 'YesYes':
					var _v1 = _v0.a;
					...
					return A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('What happens if this happens?')
							]));
				case 'YesNo':
					var _v3 = _v0.a;
					var _v4 = _v0.b;
					return A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('What if it '),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('doesn’t')),
								$mdgriffith$elm_ui$Element$text(' happen?')
							]));
				case 'NoYes':
					var _v5 = _v0.a;
					var _v6 = _v0.b;
					return A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('What '),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('will not')),
								$mdgriffith$elm_ui$Element$text(' happen if this happens?')
							]));
				default:
					var _v7 = _v0.a;
					var _v8 = _v0.b;
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('won’t')),
								$mdgriffith$elm_ui$Element$text(' happen if it '),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
			...
			switch (_v0.b.$) {
				case 'YesYes':
					...
					return A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Что я '),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('получу')),
								$mdgriffith$elm_ui$Element$text(', если '),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('приму')),
								$mdgriffith$elm_ui$Element$text(' это решение?')
							]));
				case 'YesNo':
					var _v11 = _v0.a;
					var _v12 = _v0.b;
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('не приму')),
								$mdgriffith$elm_ui$Element$text(' это решение?')
							]));
				case 'NoYes':
					var _v13 = _v0.a;
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('потеряю')),
								$mdgriffith$elm_ui$Element$text(', если '),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
...
var $author$project$Main$green = A3($mdgriffith$elm_ui$Element$rgb255, 16, 185, 129);
var $author$project$Main$red = A3($mdgriffith$elm_ui$Element$rgb255, 239, 68, 68);
var $author$project$Main$yellow = A3($mdgriffith$elm_ui$Element$rgb255, 245, 158, 11);
var $author$project$Main$questionSquareColor = function (questionType) {
	switch (questionType.$) {
		case 'YesYes':
...
var $author$project$Main$questionTypeToRoute = function (questionType) {
	switch (questionType.$) {
		case 'YesYes':
			return 'yes-yes';
		case 'YesNo':
...
var $author$project$Main$showAnswer = function (answerText) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text(answerText));
};
var $mdgriffith$elm_ui$Internal$Model$CenterY = {$: 'CenterY'};
var $mdgriffith$elm_ui$Element$centerY = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$CenterY);
var $author$project$Main$styleQuestionTitle = function (center) {
	return center ? $mdgriffith$elm_ui$Element$centerY : A2($mdgriffith$elm_ui$Element$paddingXY, 0, 20);
};
var $author$project$Main$showQuestion = F2(
	function (questionText, answers) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			$author$project$Main$fillStyle,
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
							...
							$author$project$Main$styleQuestionTitle(
					...
					A2(
						$elm$core$List$map,
						$author$project$Main$showAnswer,
						A2(
							$elm$core$List$map,
							function ($) {
								return $.text;
...
var $author$project$Main$questionLink = F3(
	function (questionType, questionText, answers) {
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$questionSquareColor(questionType))
				]),
			{
				label: A2($author$project$Main$showQuestion, questionText, answers),
				url: $author$project$Main$questionTypeToRoute(questionType)
			});
	});
var $author$project$Main$getSquare = F2(
	function (language, quesiton) {
		if (quesiton.$ === 'Just') {
			var questionType = quesiton.a.questionType;
			var answers = quesiton.a.answers;
			var text = A2($author$project$Main$getTranslatedText, language, questionType);
			var linkElement = A3($author$project$Main$questionLink, questionType, text, answers);
			switch (questionType.$) {
				case 'YesYes':
					return A2(
						$mdgriffith$elm_ui$Element$el,
...
var $author$project$Main$AddAnswer = function (a) {
	return {$: 'AddAnswer', a: a};
};
var $author$project$Main$ChangeNewAnswer = F2(
	function (a, b) {
		return {$: 'ChangeNewAnswer', a: a, b: b};
	});
var $author$project$Main$ChangeAnswer = F2(
	function (a, b) {
...
var $author$project$Main$idAttr = function (idValue) {
	return $mdgriffith$elm_ui$Element$htmlAttribute(
		$elm$html$Html$Attributes$id(idValue));
};
...
var $author$project$Main$questionColor = function (questionType) {
	switch (questionType.$) {
		case 'YesYes':
			return A3($mdgriffith$elm_ui$Element$rgb255, 236, 253, 245);
		case 'YesNo':
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Background$color(
					$author$project$Main$questionColor(question.questionType))
				]),
			_List_fromArray(
				[
					A2(
					...
					A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						A2($author$project$Main$getTranslatedText, language, question.questionType))),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
					...
					A2(
						...
						A2($elm$core$List$map, $author$project$Main$answerView, question.answers),
						_List_fromArray(
							[
								A2(
								$mdgriffith$elm_ui$Element$Input$text,
...
var $author$project$Main$mainElement = function (model) {
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(
									$author$project$Main$getSquare,
									model.language,
									A2($author$project$Main$getQuestionByType, $author$project$Main$YesNo, model.questions)),
									A2(
									$author$project$Main$getSquare,
									model.language,
									A2($author$project$Main$getQuestionByType, $author$project$Main$YesYes, model.questions))
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							$author$project$Main$fillStyle,
							_List_fromArray(
								[
									...
									$author$project$Main$getSquare,
									model.language,
									A2($author$project$Main$getQuestionByType, $author$project$Main$NoNo, model.questions)),
									A2(
									$author$project$Main$getSquare,
									model.language,
									A2($author$project$Main$getQuestionByType, $author$project$Main$NoYes, model.questions))
								]))
						]))
				]));
	}
...
var $author$project$Main$view = function (model) {
	var languageColor = function () {
		var _v0 = $author$project$Main$routeToQuestionType(
			A2($elm$core$String$dropLeft, 1, model.url.path));
		if (_v0.$ === 'Just') {
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$inFront($author$project$Main$info),
						$mdgriffith$elm_ui$Element$inFront(
						$author$project$Main$languageChange(languageColor))
					]),
				$author$project$Main$mainElement(model))
			]),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Answer":{"args":[],"type":"{ id : Basics.Int, text : String.String }"},"Main.Question":{"args":[],"type":"{ questionType : Main.QuestionType, field : String.String, answers : List.List Main.Answer }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"ChangeAnswer":["Basics.Int","String.String"],"AddAnswer":["Main.Question"],"ChangeNewAnswer":["Main.QuestionType","String.String"],"ChangeLanguage":["Main.Translation"],"NoOp":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Main.QuestionType":{"args":[],"tags":{"YesYes":[],"YesNo":[],"NoYes":[],"NoNo":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Main.Translation":{"args":[],"tags":{"En":[],"Ru":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});
